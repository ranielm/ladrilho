...
export function JoinRoom({ onJoinRoom, onBack, initialRoomId = '' }: JoinRoomProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-slate-800 border border-slate-700 rounded-xl p-8 w-full max-w-md shadow-2xl"
    >
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 
                       bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-lg 
